...
describe('userreducer', () => {
    ...
    it('Должен регистрировать пользователя при получении данных', () => {
        expect(userReducer({
            ...
            type: ActionTypes.GET_USER_REGISTER_SUCCESS,
            user: {
    ...
    it('Должен разлогинивать пользователя, обнуляя данные', () => {
        expect(userReducer({
            ...
            type: ActionTypes.GET_USER_LOGOUT_SUCCESS,
        })).toEqual({
            // initialState: {
                user: null,
                userDataRequest: false,
    ...
    it('Должен менять флаг, что пользователь забыл пароль', () => {
        expect(userReducer({
            ...
            type: ActionTypes.GET_USER_FORGOT_PASSWORD_SUCCESS
        })).toEqual({
            user: null,
            userDataRequest: false,
            userDataError: false,
    ...
    it('Должен менять флаг, что юзер обновил пароль', () => {
        expect(userReducer({
            ...
            type: ActionTypes.GET_USER_RESET_PASSWORD_SUCCESS
        })).toEqual({
            user: null,
            userDataRequest: false,
            userDataError: false,
    ...
    //     }, 
    //     {
    //         type: ActionTypes.GET_USER_REFRESH_TOKEN_SUCCESS,
    //     } 
    //     )).toEqual({
    //         user: {
    //             email: 'user@mail.com',
    ...
    it('Должен обновлять данные пользователя', () => {
        expect(userReducer({
            ...
            type: ActionTypes.GET_USER_INFO_UPDATE_SUCCESS,
            user: {
